...
public class RealSenseDeviceInspectorOriginal : MonoBehaviour {
...
//[CustomEditor(typeof(RealSenseDeviceInspectorOriginal))]
public class RealSenseDeviceInspectorEditorOriginal : Editor
{
    ...
    {
        RealSenseDeviceInspectorOriginal deviceInspector = (RealSenseDeviceInspectorOriginal)target;
